...
const CORE_VALUES = [
  {
    ...
    title: 'Privacy First',
    description:
      'Your files, your control. We never scan, index, or monetize your content.',
    color: 'text-chart-1',
    bg: 'bg-chart-1/10',
  },
  {
    ...
    description:
      'Optimized upload flows with chunked transfers and edge caching.',
    color: 'text-primary',
    bg: 'bg-primary/10',
  },
  {
...
async function getContributors() {
  ...
  try {
    ...
    const contribPromises = repoNames.map((name: string) =>
      fetch(
        `https://api.github.com/repos/${org}/${name}/contributors?per_page=100`,
        {
          headers,
          next: { revalidate: 60 * 60 },
        }
...
export const metadata = buildPageMetadata({
  title: 'About Us',
  description:
    'Emberly is an open source platform for file sharing, URL shortening, and talent discovery. Privacy-first, developer-friendly, and built for teams.',
})
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="mt-6 text-lg text-muted-foreground max-w-xl leading-relaxed">
                  Emberly started as a privacy-first file sharing tool for
                  developers and has grown into a full platform: file hosting,
                  URL shortening, and Nexium our built in talent discovery and
                  squad collaboration network. Self-hostable, open source, and
                  built for teams.
                </p>
                  ...
                  <GlassCard className="relative animate-float">
                    <div className="p-6">
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed">
                        Build and share more than just files. Emberly gives you
                        the tools to host content, shorten links, discover
                        talent, and collaborate with squads — all in one open
                        source platform.
                      </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {CORE_VALUES.map((value) => (
            <GlassCard key={value.title} className="glass-hover group">
              <div className="p-6">
                <div
                  className={`inline-flex p-3 rounded-xl ${value.bg} group-hover:scale-110 transition-transform`}
                >
          ...
          <GlassCard className="lg:col-span-2">
            <div className="p-8">
              ...
              <p className="mt-4 text-muted-foreground leading-relaxed">
                We built Emberly because existing file sharing solutions are
                either too complex, too expensive, or don&apos;t respect your
                privacy. Emberly prioritizes speed, privacy, and a pleasant UX.
                It&apos;s built so teams can self-host without wrestling with
                complex infrastructure.
              </p>
              <p className="mt-4 text-muted-foreground leading-relaxed">
                As Emberly has grown, so has the scope. File hosting is the core
                — but now we also offer URL shortening, rich embed previews, and
                Discovery: a talent discovery and squad collaboration platform.
                Whether you&apos;re a developer, creator, or community builder,
                Emberly scales with you while keeping your data under your
                control.
              </p>
          ...
          <GlassCard>
            <div className="p-6 h-full flex flex-col">
              ...
              <p className="mt-3 text-sm text-muted-foreground flex-1">
                ...
                repo for issues and contributor guidelines, or join our Discord
        ...
        <GlassCard className="gradient-border-animated">
          <div className="p-8 text-center">
            ...
            <p className="mt-3 text-muted-foreground max-w-xl mx-auto">
              Join thousands of developers, creators, and teams who use Emberly
              to share, build, and connect.
            </p>
