...
import {
  ...
  AlertDescription,
  AlertTitle,
} from '@/packages/components/ui/alert'
...
export const metadata = buildPageMetadata({
  title: 'Legal',
  description:
    'Emberly legal hub: Terms of Service, Privacy Policy, Cookie Policy, Security Policy, and GDPR information.',
})
...
export default async function LegalHubPage() {
  ...
  return (
    <PageShell
      title="Legal"
      subtitle="Terms of Service, Privacy Policy, and other legal documents."
      bodyVariant="plain"
    >
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground line-clamp-3">
                        {row.summary || 'Read the full document.'}
                      </p>
                    </div>
