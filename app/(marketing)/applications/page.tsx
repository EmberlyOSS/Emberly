...
export const metadata = buildPageMetadata({
  title: 'Applications',
  description:
    'Apply to join the Emberly team, become a partner, request verification, or appeal a ban.',
})
...
const APPLICATION_CARDS = [
  ...
  },
  {
    ...
    description:
      'Collaborate and cross-promote. Grow your audience alongside Emberly.',
    color: 'text-chart-3',
    bg: 'bg-chart-3/10',
    badge: 'Partnership',
  },
  {
    ...
    title: 'Get Verified',
    description:
      'Request verification for your profile to build trust with your audience.',
    color: 'text-primary',
    bg: 'bg-primary/10',
    badge: 'Verification',
  },
  {
    ...
    title: 'Appeal a Ban',
    description:
      'Request review of an account suspension by a senior team member.',
    color: 'text-chart-5',
    bg: 'bg-chart-5/10',
    badge: 'Ban Appeal',
  },
          ...
          <div className="p-8 md:p-12">
            <div className="max-w-2xl">
              ...
              <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                Whether you want to join our team, partner with us, get
                verified, or appeal a decision submit your application below.
              </p>
            </div>
          </div>
        </GlassCard>
