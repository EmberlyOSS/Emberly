...
import { ArrowRight, MapPin, Search, Sparkles, Users, Zap } from 'lucide-react'
      ...
      <div className="container space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground max-w-lg leading-relaxed">
                  Browse creators, developers, and community leaders open to
                  opportunities proof-backed by real work and verified skills.
                </p>
              </div>
        ...
        <div className="rounded-2xl glass p-5 space-y-4">
          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            {(
              Object.entries(NEXIUM_AVAILABILITY_LABELS) as [string, string][]
            ).map(([val, label]) => (
              <Link
                key={val}
          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            {(
              Object.entries(NEXIUM_LOOKING_FOR_LABELS) as [
                NexiumLookingFor,
                string,
              ][]
            ).map(([val, label]) => (
          ...
          {profiles.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {profiles.map((profile) => {
                const displayName =
                  profile.user.fullName ?? profile.user.name ?? 'Unknown'
                  ...
                  >
                    <div className="p-5 flex flex-col gap-3 flex-1">
                      ...
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <span
                          className={`text-[10px] px-2 py-0.5 rounded-full border font-medium ${availabilityBadgeClass(profile.availability)}`}
                        >
                          {
                            NEXIUM_AVAILABILITY_LABELS[
                              profile.availability as keyof typeof NEXIUM_AVAILABILITY_LABELS
                            ]
                          }
                        </span>
                      </div>
