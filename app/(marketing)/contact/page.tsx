...
const QUICK_LINKS = [
  { icon: BookOpen, label: 'Blog', href: '/blog' },
  {
    icon: Bug,
    label: 'Bug Reports',
    href: 'https://github.com/EmberlyOSS/Emberly/issues/new?template=bug_report.md',
  },
  {
    icon: Zap,
    label: 'Feature Requests',
    href: 'https://github.com/EmberlyOSS/Emberly/issues/new?template=feature_request.md',
  },
]
...
export const metadata = buildPageMetadata({
  title: 'Contact',
  description:
    "Get in touch with the Emberly team - we'd love to hear from you.",
})
          ...
          <div className="p-8 md:p-12">
            <div className="max-w-2xl">
              ...
              <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                Questions, feedback, partnership inquiries, or just want to say
                hi? Choose your preferred way to reach us below.
              </p>
            </div>
          </div>
        </GlassCard>
        ...
        <GlassCard>
          <div className="p-8 text-center">
            ...
            <p className="mt-3 text-muted-foreground max-w-xl mx-auto">
              Check out our blog for the latest updates and guides, or reach out
              directly and we'll point you in the right direction.
            </p>
