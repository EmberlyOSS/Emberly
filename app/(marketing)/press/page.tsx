...
const PRESS_RESOURCES = [
  {
    ...
    title: 'Media Kit',
    description:
      'Logos, screenshots, brand colors, and usage guidelines for press and partners.',
  ...
  },
  {
    ...
    description:
      'How to properly represent Emberly in articles, presentations, and media.',
...
export const metadata = buildPageMetadata({
  title: 'Press & Media',
  description:
    'Press resources, media kit, and contact information for journalists and media partners.',
})
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                  Everything you need to write about Emberly. Download our media
                  kit, access brand assets, or get in touch for interviews and
                  inquiries.
                </p>
                    ...
                    <div className="p-6">
                      ...
                      <div className="mt-6 p-4 rounded-xl bg-muted/30">
                        ...
                        <p className="text-sm text-muted-foreground italic">
                          "A lightweight, developer first file sharing platform
                          focused on privacy, reliability, and simplicity."
                        </p>
                      </div>
                    </div>
                  </GlassCard>
          ...
          {PRESS_RESOURCES.map((resource) => (
            ...
            >
              <div className="p-6 h-full flex flex-col">
                <div
                  className={`inline-flex p-3 rounded-xl ${resource.bg} w-fit`}
                >
          ...
          <GlassCard className="lg:col-span-2">
            <div className="p-8">
              ...
              <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Emberly is an open-source file sharing platform designed for
                  developers, teams, and communities who value privacy and
                  simplicity. Built with modern web technologies, it offers a
                  self hostable alternative to traditional cloud storage
                  services.
                </p>
                <p>
                  Key features include password-protected files, custom domains,
                  rich embeds, chunked uploads for large files, and a clean,
                  intuitive dashboard for content management. The platform is
                  fully open source under the GPL 3.0 license, allowing anyone
                  to audit, modify, and self host their own instance.
                </p>
                <p>
                  Founded in 2022, Emberly is maintained by a remote first team
                  of developers passionate about privacy respecting software.
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  Download our logo in various formats. Always use the official
                  assets when representing Emberly.
                </p>
              </div>
