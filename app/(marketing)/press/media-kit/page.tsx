      ...
      <div className="container space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <Button
              ...
              size="sm"
              asChild
              className="-ml-2 text-muted-foreground mb-4"
            >
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            Short promotional clips for use in presentations, social media, and
            press coverage.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <GlassCard id="guidelines">
          <div className="p-8">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Colors adapt to the active theme. These are the current
              theme&apos;s colors.
            </p>
            <ThemeColorPalette />
          </div>
        ...
        <GlassCard>
          <div className="p-8">
            ...
            <div className="mt-6 p-4 glass-subtle">
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">Note:</strong> Inter is
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li>
                      • Always capitalize: <strong>Emberly</strong>
                    </li>
          ...
          <GlassCard>
            <div className="p-6 h-full flex flex-col">
              ...
              <p className="text-sm text-muted-foreground flex-1">
                Contact us for custom assets, interview requests, or bespoke
                materials.
              </p>
...
function AssetPreview({ variant, theme }: AssetPreviewProps) {
  const baseClasses =
    'flex h-40 w-full items-center justify-center rounded-xl border border-border/30'
  ...
  if (variant === 'wordmark') {
    return (
      <div className={`${baseClasses} ${background}`}>
        <span
          className={`text-3xl font-bold tracking-wide ${theme === 'dark' ? 'text-foreground' : 'text-foreground'}`}
        >
          EMBERLY
        </span>
      </div>
    ...
    return (
      <div className={`${baseClasses} ${background}`}>
        <div className="rounded-full border border-dashed border-border p-6">
          <Image
            src="/icon.svg"
            alt="Emberly monochrome"
            width={48}
            height={48}
            className={theme === 'light' ? 'dark:invert-0' : ''}
          />
        </div>
      </div>
    )
  ...
  return (
    <div className={`${baseClasses} ${background}`}>
      <div className="flex items-center gap-3">
        ...
        <span className="text-2xl font-bold text-foreground">Emberly</span>
      </div>
    </div>
  )
}
...
function ThemeColorPalette() {
  const [colors, setColors] = useState<
    { name: string; hex: string; rgb: string; usage: string }[]
  >([])
    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
        {THEME_COLORS.map((color) => (
          <div
            key={color.name}
            className="glass-subtle overflow-hidden animate-pulse"
          >
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
      {colors.map((color) => {
        ...
        return (
          <div key={color.name} className="group glass-subtle overflow-hidden">
            <div
